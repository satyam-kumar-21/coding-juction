  ...
  const contactMethods = [
    {
      ...
      contact: "codingjuctionsupport@example.com",
    },
    {
      icon: (
        <svg
    ...
    },
    {
      ...
      contact: "176, press colony, anand nagar Bhopal",
    },
  ];
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  type="text"
                  required
                  className="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none bg-white focus:border-indigo-600 shadow-sm rounded-lg"
                />
              </div>
              <div>
                ...
                <input
                  type="email"
                  required
                  className="w-full bg-white mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
                />
              </div>
